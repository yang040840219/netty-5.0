...
public final class NioEventLoop extends SingleThreadEventLoop {
    ...
    public void register(final SelectableChannel ch, final int interestOps, final NioTask<?> task) {
        ...
        //System.out.println("NioEventLoop register");
    }
    ...
    @Override
    protected void run() {
        //System.out.println("NioEventLoop run()") ;
    ...
    private void processSelectedKeysPlain(Set<SelectionKey> selectedKeys) {
        ...
        for (;;) {
            ...
            if (a instanceof AbstractNioChannel) {
                //System.out.println("NioEventLoop processSelectedKeysPlain  " + a) ;
    ...
    private void processSelectedKeysOptimized(SelectionKey[] selectedKeys) {
        for (int i = 0;; i ++) {
            ...
            if (a instanceof AbstractNioChannel) {
                //System.out.println("NioEventLoop processSelectedKeysOptimized  " + a) ;
                processSelectedKey(k, (AbstractNioChannel) a);
            } else {
                @SuppressWarnings("unchecked")
                NioTask<SelectableChannel> task = (NioTask<SelectableChannel>) a;
    ...
    private static void processSelectedKey(SelectionKey k, AbstractNioChannel ch) {
        ...
        //System.out.println("unsafe :" + unsafe.getClass());
        if (!k.isValid()) {
            // close the channel if the key is not valid anymore
            unsafe.close(unsafe.voidPromise());
            return;
        }
        //System.out.println("readyOps :" + k.readyOps()) ;
        try {
    ...
    private void select(boolean oldWakenUp) throws IOException {
        //System.out.println("NioEventLoop select(boolean oldWakenUp)") ;
