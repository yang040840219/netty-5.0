...
abstract class AbstractChannelHandlerContext implements ChannelHandlerContext, ResourceLeakHint {
    ...
    public final ChannelHandlerInvoker invoker() {
        //System.out.println("AbstractChannelHandlerContext ChannelHandlerInvoker invoker() : " + invoker) ;
        if (invoker == null) {
    ...
    public ChannelHandlerContext fireChannelRegistered() {
        ...
        //System.out.println("ChannelHandlerContext next.invoker() " + next.invoker().getClass().getName()) ;
    ...
    public ChannelHandlerContext fireChannelRead(Object msg) {
        AbstractChannelHandlerContext next = findContextInbound();
        //System.out.println("AbstractChannelHandlerContext fireChannelRead next " + next.getClass().getName()) ;
    ...
    public ChannelFuture write(Object msg, ChannelPromise promise) {
        AbstractChannelHandlerContext next = findContextOutbound();
        System.out.println("AbstractChannelHandlerContext write next :" + next.getClass().getName()) ;
        ReferenceCountUtil.touch(msg, next);
