...
public class DefaultChannelHandlerInvoker implements ChannelHandlerInvoker {
    ...
    public void invokeChannelRead(final ChannelHandlerContext ctx, final Object msg) {
        ...
        if (executor.inEventLoop()) {
            ...
            safeExecuteInbound(new OneTimeTask() {
                @Override
                public void run() {
                    System.out.println("DefaultChannelHandlerInvoker invokeChannelRead 启动新的 OneTimeTask 执行 invokeChannelReadNow") ;
                    invokeChannelReadNow(ctx, msg);
                }
            }, msg);
        }
    ...
    public void invokeWrite(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) {
        ...
        //System.out.println("DefaultChannelHandlerInvoker invokeWrite executor.inEventLoop() :" + executor.inEventLoop()) ;
        if (executor.inEventLoop()) {
