...
public abstract class AbstractBootstrap<B extends AbstractBootstrap<B, C>, C extends Channel> implements Cloneable {
    ...
    public B group(EventLoopGroup group) {// group 为 bossEventGroup[NioEventLoopGroup]
        if (group == null) {
    ...
    final ChannelFuture initAndRegister() {
        ...
        //System.out.println("ChannelFactory :" + channelFactory().getClass());
        ...
        //System.out.println("group :" + group().getClass()) ;
        ChannelFuture regFuture = group().register(channel); // NIOEventLoopGroup
